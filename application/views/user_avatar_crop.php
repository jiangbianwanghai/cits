...
<title>裁剪照片</title>
<script src="<?php echo STATIC_HOST; ?>/js/jquery-1.7.1.min.js" type="text/javascript"></script>
<script src="<?php echo STATIC_HOST; ?>/js/jquery.Jcrop_new.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?php echo STATIC_HOST; ?>/css/jquery.Jcrop.min.css" type="text/css" />
  ...
  $(document).ready(function(){
    ...
    $("#confirmOk").click(function(){     
      if (parseInt($('#w').val())){
        ...
        var w = $("#w").val();
        var h = $("#h").val();
        $.post("/user/avatar_submit",{pic_name:pic_name,x:x,y:y,w:w,h:h},function(data){
