      ...
      <div class="row">
         ...
         <div class="col-sm-3 col-lg-2">
          <ul class="nav nav-pills nav-stacked nav-email">
            ...
            <li class="active"><a href="/repos/add"><i class="fa fa-plus"></i>添加代码库</a></li>
          </ul>
        </div><!-- col-sm-3 -->
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="repos_name" name="repos_name" class="form-control" placeholder="请输入代码库名称" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="repos_name_other" name="repos_name_other" class="form-control" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="repos_url" name="repos_url" class="form-control" placeholder="请输入代码库地址" required />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="rdio rdio-primary">
                      <input type="radio" id="you" value="1" name="merge" required />
                      <label for="you">需要</label>
                    </div><!-- rdio -->
                    <div class="rdio rdio-primary">
                      <input type="radio" value="0" id="wu" name="merge">
