...
<ul class="nav nav-pills nav-stacked nav-email">
  <li<?php if ($this->uri->segment(2, 'index') == 'plan') {?> class="active"<?php } ?>><a href="/heartbeat"><i class="fa fa-square<?php if ($this->uri->segment(2, 'index') != 'index') echo '-o'; ?>"></i> 计划列表</a></li>
